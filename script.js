...
function initializeAnimations() {
  ...
  aboutContainers?.querySelectorAll('.details-container').forEach(container => {
...
function updateProgress() {
  ...
  document.getElementById('progress-text').textContent = 
    `${currentEpoch}/${totalEpochs} [${Array(20).fill('=').slice(0, Math.floor(progress * 20)).join('')}${
      Array(20).fill('.').slice(Math.floor(progress * 20)).join('')}] - ${(progress * 100).toFixed(1)}%`;
...
const achievements = [
  ...
  },
  {
    ...
    description: "Participating in the Google AI Hackathon, hosted on Devpost, was an exhilarating month-long journey that pushed our team to new heights. This online event drew over 15,000 participants from around the globe, creating a highly competitive and innovative environment. Our team's dedication, creativity, and technical prowess were put to the test as we developed cutting-edge AI solutions to address real-world challenges. Through countless hours of collaboration, problem-solving, and iterative development, we managed to secure a place in the top 25 teams. This achievement not only validated our skills and hard work but also provided us with invaluable experience in applying AI technologies to practical problems. The exposure to diverse ideas and the opportunity to learn from industry experts throughout the hackathon has significantly enhanced our understanding of AI's potential and its applications across various domains.",
